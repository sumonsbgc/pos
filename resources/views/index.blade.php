                            ...
                            <div class="card-content">
                                <div class="media align-items-stretch">
                                    <div class="p-2 text-center bg-primary bg-darken-2">
                                        <i class="fa fa-shopping-bag font-large-2 white"></i>
                                    </div>
                            ...
                            <div class="card-content">
                                <div class="media align-items-stretch">
                                    <div class="p-2 text-center bg-danger bg-darken-2">
                                        <i class="fa fa-database font-large-2 white"></i>
                                    </div>
                            ...
                            <div class="card-content">
                                <div class="media align-items-stretch">
                                    ...
                                    <div class="p-2 bg-gradient-x-warning white media-body">
                                        <h5>Total Sale</h5>
                                        <h5 class="text-bold-400 mb-0"><i class="ft-arrow-down"></i> {{$total_sale}}</h5>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-content">
                                <div class="media align-items-stretch">
                                    ...
                                    <div class="p-2 bg-gradient-x-success white media-body">
                                        <h5>Profit</h5>
                                        <h5 class="text-bold-400 mb-0"><i class="ft-arrow-up"></i> {{$profit}}</h5>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div id="recent-buyers" class="media-list height-300 position-relative">
                                    <a href="#" class="media border-0">
                                        <div class="media-body w-100">
                                            <h6 class="list-group-item-heading">{{$supplier->supplier_name}}<span
                                                        class="font-medium-4 float-right pt-1">{{$supplier->total_amount}}</span></h6>
                                            <p class="list-group-item-text mb-0"><span class="badge badge-primary">{{$supplier->company_name}}</span></p>
                                        </div>
                                    </a>
                                </div>
                            </div>
                ...
                <div class="row match-height">
                    <div class="col-xl-8 col-lg-12">
                        <div class="card">
                            ...
                            <div class="card-content">
                                <div class="card-body">
                                    <p>Total paid invoices {{$total_paid}}, unpaid {{$total_unpaid}}. <span class="float-right"><a
                                                    href="{{url('/sales_history')}}" target="_blank">Invoice Summary <i
                                ...
                                <div class="table-responsive">
                                    <table id="recent-orders" class="table table-hover mb-0 ps-container ps-theme-default">
                                        ...
                                        <tr>
                                            <td class="text-truncate"><a href="{{url('/product_invoice/'.$sell->receipt_no)}}">{{$sell->receipt_no}}</a></td>
                                            <td class="text-truncate">{{$sell->customer_name}}</td>
                                            <td class="text-truncate">

                                                @if($sell->retail_rate * $sell->sale_quantity == $sell->receive_amount)
                                                <span class="badge badge-default badge-success">Paid</span>
                                                @else
                                                <span class="badge badge-default badge-warning">Overdue</span>
                                                    @endif
                                            </td>
                                            <td class="text-truncate">{{$sell->retail_rate * $sell->sale_quantity}}</td>
                                        </tr>
                                            @endforeach
                                        </tbody>
                                    </table>
