...
<!-- Mirrored from pixinvent.com/stack-responsive-bootstrap-4-admin-template/html/ltr/vertical-modern-menu-template/login-simple.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 06 Dec 2018 17:40:16 GMT -->
<head>
    ...
    <link rel="apple-touch-icon" href="{{asset('template_asset/app-assets/images/ico/apple-icon-120.png')}}">
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('template_asset/app-assets/css/core/menu/menu-types/vertical-menu-modern.css')}}">
                        ...
                        <div class="card border-grey border-lighten-3 m-0">
                            <div class="card-header border-0">
                                <div class="card-title text-center">
                                    <div class="p-1"><img src="{{asset('template_asset/app-assets/images/logo/stack-logo-dark.png')}}" alt="branding logo"></div>
                                </div>
